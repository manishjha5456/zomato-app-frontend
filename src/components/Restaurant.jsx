                    ...
                    <div className="row p-2" key={menu._id} >
                      ...
                      <div className="col-4 d-flex justify-content-end">
                        <div className="menu-food-item">
                          ...
                          {
                            menu.qty === 0 ?
                            (<button onClick={()=>incQty(index)} className="btn btn-primary btn-sm add">Add</button>)
                            :
                            (<div className="order-item-count section ">
                              <span className="hand bg-primary text-white fw-bold px-2 rounded-3" onClick={()=>decQty(index)} >-</span>
                              <span className="px-2 rounded-3">{menu.qty}</span>
                              <span className="hand bg-primary text-white fw-bold rounded-3" onClick={()=>incQty(index)}>+</span>
                            </div>)
                          }
                        </div>
                      </div>
        ...
        <div className="modal-content">
          <div className="modal-header">
              ...
              <div className="modal-body">
                ...
                <i>Your payment for this order is <b className="text-primary">{totalPrice}</b> /- Ruppes only</i>
              </div>
